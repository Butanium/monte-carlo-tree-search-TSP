...
let file_path = "C:/Users/.../tsp" (* your path MO the tsp direcMOry, use the path from root if it doesn't work *)
...
let () = Showtsp.show_solution_and_wait cities path; (* Show the computed solution *)
